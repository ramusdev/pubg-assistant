...
public class SettingsFragment extends Fragment implements View.OnClickListener, OnUserEarnedRewardListener {

    public View view;
    // public static final String REWARDED_INTERSTITIAL_ID = "ca-app-pub-3940256099942544/5354046379";
    public static final String REWARDED_INTERSTITIAL_ID = "ca-app-pub-4140002463111288/3172796665";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String text = MyApplicationContext.getAppContext().getResources().getString(R.string.settings_text);
    ...
    public void loadRewarded(boolean isShow) {
        RewardedInterstitialAd.load(MyApplicationContext.getAppContext(), REWARDED_INTERSTITIAL_ID, new AdRequest.Builder().build(), new RewardedInterstitialAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull RewardedInterstitialAd rewardedInterstitialAd) {
                ...
                SettingsFragment.this.rewardedInterstitialAd = rewardedInterstitialAd;
                SettingsFragment.this.rewardedInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    @Override
    ...
    public void showRewarded() {
        if (rewardedInterstitialAd != null) {
            rewardedInterstitialAd.show(getActivity(), SettingsFragment.this);
        } else {
            loadRewarded(true);
        }
    ...
    public void showMessage() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                String text = MyApplicationContext.getAppContext().getResources().getString(R.string.settings_message);
